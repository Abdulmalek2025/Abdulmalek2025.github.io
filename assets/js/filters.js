(function() {
    ...
    /*canvas.on({
      'selection:created': function() {
        fabric.util.toArray(document.querySelectorAll('#filters-form input'))
                            .forEach(function(el){ el.disabled = false; });

        fabric.util.toArray(document.querySelectorAll('#filters-form select'))
                            .forEach(function(el){ el.disabled = false; });
    ...
    $('remove-color-color').oninput = function() {
